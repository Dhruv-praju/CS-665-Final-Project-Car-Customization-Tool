 ...
 * Date: 05/02/2024
 * File Name: HondaSedanBuilder.java
 * Description: This class represents a concrete builder for constructing Honda sedan cars.
 */
 ...
 /**
  * This class represents a concrete builder for constructing Honda sedan cars.
  */
 public class HondaSedanBuilder implements CarBuilder {
     private Car car;
 
     public HondaSedanBuilder() {
         this.car = new Car();
