 ...
 * Date: 05/02/2024
 * File Name: ToyotaSUVBuilder.java
 * Description: This class represents a concrete builder for constructing Toyota SUV cars.
 * 
 * Class Responsibilities:
 * - Constructs instances of Toyota SUV cars by implementing the CarBuilder interface.
 * - Initializes a new Car object with Toyota as the company and SUV as the car type upon construction.
 ...
 */
 ...
 /**
  * This class represents a concrete builder for constructing Toyota SUV cars.
  */
 public class ToyotaSUVBuilder implements CarBuilder {
     private Car car;
 
     /**
      * Constructs a ToyotaSUVBuilder and initializes a new Car instance with Toyota as the company and SUV as the car type.
      */
     public ToyotaSUVBuilder() {
         this.car = new Car();
